...
export const ROUTES = {
  ...
  '/about': {
    ...
    desc: {
      en: 'Licensed real estate company in Oman selling freehold property to all nationalities: 400+ units in 12 projects from OMR 61,635, plus residency and company setup.',
      ru: 'Лицензированное агентство недвижимости в Омане: фригольд для любых гражданств, более 400 объектов в 12 проектах от 61 635 риалов, резидентство и регистрация компании.',
      ar: 'شركة عقارية مرخصة في عُمان تبيع التملك الحر لجميع الجنسيات: أكثر من 400 وحدة في 12 مشروعاً من 61,635 ريالاً، مع الإقامة وتأسيس الشركات.',
      fa: 'آژانس املاک دارای مجوز در عمان، فروش فری‌هولد به همه ملیت‌ها: بیش از ۴۰۰ واحد در ۱۲ پروژه از ۶۱٬۶۳۵ ریال، به‌همراه اقامت و ثبت شرکت.',
    },
  },
  '/insights': {
    title: {
  ...
  '/oman-property-for-iranians-in-uae': {
    langs: ['fa'],
    title: {
      fa: 'خرید ملک در عمان برای ساکنین امارات ۲۰۲۶ | ایرفان',
      en: 'Oman Property for Iranians Living in the UAE | Irfan Investment',
    },
    desc: {
      fa: 'خرید ملک در عمان برای ساکنین امارات: فری‌هولد برای هر ملیتی از ۵۸۸٬۷۰۰ درهم، اقامت قابل تمدید، مقایسه قیمت با دبی و ۴۵۲ واحد موجود.',
  ...
  '/persian-speaking-real-estate-agency-oman': {
    ...
    desc: {
      fa: 'کارگزاری املاک با مشاوران فارسی‌زبان و دفتر در مسقط و تهران. انتخاب واحد، بررسی قرارداد، ثبت سند و اقامت مالک ملک به فارسی. ۴۵۲ واحد از ۶۱٬۶۳۵ ریال عمان.',

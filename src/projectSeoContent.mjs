...
// Jebel Sifah studios from OMR 35,625, Muscat apartments (Wadi Zaha, Sultan
// Haitham City) from OMR 48,125, Hawana Salalah chalets from OMR 98,000.
...
export const PROJECT_SEO = {
  en: {
    ...
    paras: [
      ...
      'Most of the inventory sits in Muscat, inside the freehold communities foreign buyers can actually own in: Al Mouj on the marina, Muscat Bay, Muscat Hills, the new Sultan Haitham City district and Yiti. Apartments for sale in Muscat currently start from about OMR 48,125, studios at Jebel Sifah from OMR 35,625, and beachfront chalets in Hawana Salalah from OMR 98,000. Every one of these communities is a government approved Integrated Tourism Complex, so the title is full freehold for all nationalities and the purchase qualifies you for an Oman investor residency permit.',
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Entry level apartments in Muscat currently start from around OMR 48,125 in Sultan Haitham City. If you widen the search just outside the capital, studios at Jebel Sifah start from about OMR 35,625, which is the lowest freehold entry ticket in Oman today.',
      },
      {
  ...
  fa: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'آپارتمان‌های نقطه ورود در مسقط در حال حاضر از حدود ۴۸٬۱۲۵ ریال عمان در شهر سلطان هیثم شروع می‌شوند. اگر کمی بیرون از پایتخت را هم ببینید، استودیو در جبل سیفه از حدود ۳۵٬۶۲۵ ریال عمان شروع می‌شود که ارزان‌ترین نقطه ورود فری‌هولد در عمان است.',
      },
      {
  ...
  ar: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'تبدأ الشقق الاقتصادية في مسقط حالياً من نحو 48,125 ر.ع في مدينة السلطان هيثم. وإذا وسّعت البحث خارج العاصمة قليلاً، تبدأ استوديوهات جبل سيفة من نحو 35,625 ر.ع وهي أقل نقطة دخول للتملك الحر في عُمان.',
      },
      {
  ...
  ru: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Стартовые квартиры в Маскате сейчас от примерно 48 125 OMR в Sultan Haitham City. Если расширить поиск чуть за пределы столицы, студии в Jebel Sifah начинаются от 35 625 OMR — это самый доступный вход во фрихолд в Омане.',
      },
      {

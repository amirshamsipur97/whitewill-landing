...
const en = {
  ...
  featured: {
    ...
    intro:
      'A snapshot of well-established and newly opened international schools in and around Muscat. Details are indicative and change year to year; our advisors give you a current, tailored shortlist based on your children’s ages, curriculum and preferred area.',
...
const ru = {
  ...
  featured: {
    ...
    intro:
      'Краткий обзор устоявшихся и недавно открытых международных школ в Маскате и его окрестностях. Сведения являются ориентировочными и меняются год от года; наши консультанты составят для вас актуальный персональный список с учётом возраста детей, программы и предпочитаемого района.',
...
const ar = {
  ...
  featured: {
    ...
    intro:
      'لمحة عن مدارس دولية راسخة وأخرى افتُتحت حديثاً في مسقط وما حولها. التفاصيل إرشادية وتتغير من عام لآخر؛ يقدّم مستشارونا قائمة محدّثة ومخصّصة بناءً على أعمار أطفالك والمنهج والمنطقة المفضّلة.',
...
const fa = {
  ...
  featured: {
    ...
    intro:
      'نمایی از مدارس بین‌المللی جاافتاده و تازه‌تأسیس در مسقط و پیرامون آن. جزئیات جنبه راهنما دارند و سال‌به‌سال تغییر می‌کنند؛ مشاوران ما فهرستی به‌روز و متناسب بر اساس سن فرزندان، برنامه آموزشی و منطقه دلخواه شما ارائه می‌دهند.',

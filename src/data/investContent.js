// ─────────────────────────────────────────────────────────────────────────
// investContent.js — all copy for the /invest "Company Registration &
// Investment in Oman" page. Edit the exports here; InvestPage.jsx renders
// them. Figures verified against current (2025–2026) Omani regulations:
//   • Foreign Capital Investment Law — Royal Decree 50/2019 (100% ownership)
//   • Commercial Companies Law       — Royal Decree 18/2019
//   • New Labour Law                 — Royal Decree 53/2023
//   • Income Tax Law (15%)           — Royal Decree 28/2009
//   • VAT Law (5%)                   — Royal Decree 121/2020
//   • Personal Income Tax (5%, 2028) — Royal Decree 56/2025  ← NEW
// LLCs no longer carry a statutory minimum capital; VAT registration is
// mandatory above OMR 38,500 turnover; all companies must register on the
// Tawteen employment platform as of 2026.
// ─────────────────────────────────────────────────────────────────────────
...
// ── Why Oman — headline stats ──────────────────────────────────────────────
export const WHY_OMAN = [
...
// ── 3. Foreign ownership rules (2026) ──────────────────────────────────────
...
// ── 4. Business entities — the 4 premium structures foreign investors use ───
// `theme` drives a subtle per-card accent (kept within the site's olive luxury
// palette); `featured` marks the headline card (LLC). Rendered by
// InvestEntityCards.jsx.
export const ENTITIES = [
  {
    code: 'LLC',
    name: 'Limited Liability Company',
    tagline: 'The cornerstone of business in Oman',
    price: 'OMR 1,599',
    theme: 'olive',
    featured: true,
    badge: 'Most chosen',
    description:
      'The most established and versatile entity in the Sultanate — granting up to 100% foreign ownership with full limited-liability protection. The default vehicle for companies that intend to trade, operate and scale on the Omani mainland.',
    features: [
      'Up to 100% foreign ownership in most sectors',
      'Limited liability — personal assets protected',
      '1–50 shareholders',
      'No statutory minimum capital',
      'Unrestricted mainland trading',
      'Full access to government tenders & contracts',
    ],
    advantages: [
      'The structure banks and regulators know best',
      'Eligible for investor residency visas',
      'Straightforward corporate banking',
  ...
  },
  {
    ...
    tagline: 'Full ownership, full control',
    price: 'OMR 1,499',
    theme: 'gold',
    description:
      'A limited-liability entity owned and controlled by a single shareholder — purpose-built for founders and professionals who want 100% ownership with no partners, while keeping the same legal protection as an LLC.',
    features: [
    ...
    advantages: [
      '100% ownership and decision-making power',
      'Lean administration & faster setup',
      'Eligible for corporate banking',
      'Eligible for investor residency',
  ...
  },
  {
    code: 'Branch',
    name: 'Branch Office',
    tagline: 'Your global brand, established in Oman',
    price: 'OMR 1,399',
    theme: 'slate',
    description:
      'A direct extension of your foreign parent company, enabling immediate market entry under your existing brand and balance sheet — the natural route for executing local contracts and projects.',
    features: [
      'Extension of a foreign parent company',
      'Operates under the parent’s name & reputation',
      'Direct market entry — no new legal entity',
      'Eligible to execute local contracts & projects',
      'Centralised control from headquarters',
    ],
    advantages: [
      'Fastest route to an Omani presence',
      'Leverages established corporate reputation',
      'Well-suited to government & project-based work',
      'Seamless alignment with group operations',
    ],
  ...
  },
  {
    ...
    tagline: 'Trade globally, operate tax-efficiently',
    price: 'OMR 1,299',
    theme: 'teal',
    description:
      'An entity established within Oman’s free zones — Sohar, Salalah and Duqm — offering 100% foreign ownership, customs and tax incentives, and direct access to world-class ports and logistics corridors.',
    features: [
      '100% foreign ownership',
      'Tax & customs incentives',
      'Simplified licensing',
      'Strategic access to ports & logistics hubs',
      'Streamlined import/export operations',
    ],
    advantages: [
      'Significant cost & duty savings',
      'World-class logistics & port connectivity',
      'Fast, simplified setup',
      'Built for export-oriented trade',
    ],
...
// ── 4b. Comparison table — the 4 entities side by side ─────────────────────
...
// ── 4c. Why foreign investors choose Oman ──────────────────────────────────
export const WHY_INVEST = [
  ...
  { stat: '3', title: 'Strategic Gateway', body: 'A natural hub linking the GCC, East Africa and Asia, with deep-water ports on the world’s busiest shipping routes.', statSuffix: ' continents' },
  ...
  { stat: '100%', title: 'Investor-Friendly Regulation', body: 'Remote registration via Invest Easy, streamlined licensing, and dedicated facilitation from Invest Oman.', statSuffix: ' online' },
]

// ── 4d. Premium closing CTA ────────────────────────────────────────────────
...
// ── 5. Recommended structure by business type (comparison table) ───────────
...
// ── 6. Registration process (8 steps) ──────────────────────────────────────
export const STEPS = [
...
// ── 9. Documents required from foreign investors ───────────────────────────
export const DOCS = [
...
// ── 11. Popular business activities (100% foreign-ownership compatible) ─────
export const ACTIVITIES = [
  ...
  'Import & Export of Technology Products',
  'Cloud & API Development',
  'Management Consultancy',
]

// ── 12. Compliance documents every company must maintain ───────────────────

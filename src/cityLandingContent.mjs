    ...
    ar: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'لا ننشر رقماً موحّداً للعائد، لأنه يعتمد على الوحدة نفسها ومجتمعها وما إذا كان التأجير قصير الأمد أم سنوياً. ما نقوله بثقة هو أن عُمان لا تفرض ضريبة على دخل الإيجار ولا ضريبة سنوية على العقار، فيبقى ما تحصّله لك بعد رسوم الخدمات. اطلب منا أرقام التأجير الفعلية لأي وحدة قبل أن تبني حساباتك.',
        },
        {
    ...
    ru: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'Мы не публикуем единую цифру доходности: она зависит от конкретного объекта, района и от того, сдаёте вы посуточно или на год. Что можно утверждать уверенно: в Омане нет налога на арендный доход и нет ежегодного налога на недвижимость, поэтому арендная плата остаётся у вас за вычетом сервисных сборов. Запросите у нас фактические данные по конкретному объекту, прежде чем считать.',
        },
        {
  ...
  'buy-property-in-salalah': {
    ...
    ru: {
      ...
      faq: [
        ...
        {
          q: 'Выгодна ли Салала для инвестиций в аренду?',
        ...
        },
        {
          ...
          a: 'Да. Поскольку Hawana Salalah является интегрированным туристическим комплексом, покупка там даёт владельцу инвесторскую резиденцию Омана, продлеваемую всё время владения.',
        },
      ],
      linksHeading: 'Связанные страницы',
      links: [

...
// Cheapest available Muscat home: a Wadi Zaha studio, Sultan Haitham City
// from OMR 61,635 (10% down = OMR 6,164). OMR is pegged at 1 = $2.6008,
...
// ⚠️ These are ALL derived from the entry price: when it moves, recompute the
// whole block, not just the OMR line.
const GEO_CURRENCY = {
  OM: { price: 'OMR 61,635', down: 'OMR 6,164' },
  AE: { price: 'AED 588,000', down: 'AED 58,800' },
  SA: { price: 'SAR 601,000', down: 'SAR 60,100' },
  RU: { price: '≈14 млн RUB', down: '≈1,4 млн RUB' },
}
const DEFAULT_CURRENCY = { price: '$160,000 USD', down: '$16,000 USD' }
